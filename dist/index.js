...
function setOutputs(outputs) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        core.setOutput('next-version', String(outputs === null || outputs === void 0 ? void 0 : outputs.nextVersion));
        core.setOutput('next-major', String((_d = outputs === null || outputs === void 0 ? void 0 : outputs.nextVersion) === null || _d === void 0 ? void 0 : _d.major));
        core.setOutput('next-minor', String((_e = outputs === null || outputs === void 0 ? void 0 : outputs.nextVersion) === null || _e === void 0 ? void 0 : _e.minor));
        core.setOutput('next-patch', String((_f = outputs === null || outputs === void 0 ? void 0 : outputs.nextVersion) === null || _f === void 0 ? void 0 : _f.patch));
        core.setOutput('build-version', String(outputs === null || outputs === void 0 ? void 0 : outputs.buildVersion));
        core.setOutput('build-major', String((_g = outputs === null || outputs === void 0 ? void 0 : outputs.buildVersion) === null || _g === void 0 ? void 0 : _g.major));
        core.setOutput('build-minor', String((_h = outputs === null || outputs === void 0 ? void 0 : outputs.buildVersion) === null || _h === void 0 ? void 0 : _h.minor));
        core.setOutput('build-patch', String((_j = outputs === null || outputs === void 0 ? void 0 : outputs.buildVersion) === null || _j === void 0 ? void 0 : _j.patch));
    });
}
...
class Outputs {
    constructor(version, bump) {
        ...
        if (buildVersion) {
            this.buildVersion = new semver_1.SemVer(buildVersion);
            const n = semver_1.inc(buildVersion.toString(), bump);
            const nextVersion = this.snapshotRelease ? `${n}-SNAPSHOT` : n;
            if (nextVersion) {
                this.nextVersion = new semver_1.SemVer(nextVersion);
            }
        }
    }
}
